...
<div class="container-fluid gymsupplement-header mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container py-5">
        <h1 class="display-3 text-white mb-3 animated slideInDown">Essential Oils</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb text-uppercase mb-0">
                <li class="breadcrumb-item"><a class="text-white" href="/">Home</a></li>
                <li class="breadcrumb-item text-primary active" aria-current="page">Essential Oils</li>
            </ol>
        </nav>
    </div>
</div>
            ...
            <div class=" wow fadeIn" data-wow-delay="0.1s">
                <div class="container-xxl">
                    <div class="row gy-4 mb-4">
                        <img src="<?= asset("img/essential-oils/banner/WEB-IMAGE-TITLE-5.jpg") ?>" alt="" />
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 wow fadeInUp">
                            <figure>
                                <a class="d-block" href="">
                                    <img src="<?= asset("img/essential-oils/BODY-BALANCING.jpg") ?>" class="img-fluid" alt="BODY BALANCING" data-caption="BODY BALANCING">
                                </a>
                            </figure>
                        </div>
